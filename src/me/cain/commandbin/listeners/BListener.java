...
public class BListener extends BlockListener
{
  public void onBlockPlace(BlockPlaceEvent e)
  {
    ...
    {
      if (CommandBin.plugin.getConfig().get(e.getPlayer().getName() + ".unlimited").equals(Boolean.valueOf(true)))
      {
    ...
    {
      if (CommandBin.plugin.getConfig().get("settings.block-placing-tnt").equals(Boolean.valueOf(true)))
      {
    ...
    {
      if (CommandBin.plugin.getConfig().get("settings.block-placing-lava").equals(Boolean.valueOf(true)))
      {
