    ...
    if (l.equalsIgnoreCase("crossbow"))
    {
      ...
      else if ((s instanceof Player))
      {
        if (CommandBin.plugin.pCheck((Player)s, "CommandBin.general.crossbow"))
        {
          ...
          {
            CommandBin.plugin.getConfig().set(((Player)s).getName() + ".crossbow", Boolean.valueOf(true));
          ...
          {
            CommandBin.plugin.getConfig().set(((Player)s).getName() + ".crossbow", Boolean.valueOf(false));
