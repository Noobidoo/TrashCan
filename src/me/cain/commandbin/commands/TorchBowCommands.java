  ...
  public boolean onCommand(CommandSender s, Command c, String l, String[] args)
  {
    if ((s instanceof Player))
    {
      if (l.equalsIgnoreCase("torchbow"))
      {
        ...
        else if (CommandBin.plugin.pCheck((Player)s, "Commandbin.general.torchbow"))
        {
          if (args[0].equalsIgnoreCase("on"))
          {
            CommandBin.plugin.getConfig().set(((Player)s).getName() + ".torchbow", Boolean.valueOf(true));
          ...
          {
            CommandBin.plugin.getConfig().set(((Player)s).getName() + ".torchbow", Boolean.valueOf(false));
            CommandBin.plugin.saveConfig();
