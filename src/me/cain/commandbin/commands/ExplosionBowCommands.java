    ...
    if (l.equalsIgnoreCase("explosionbow"))
    {
      ...
      else if ((s instanceof Player))
      {
        if (CommandBin.plugin.pCheck((Player)s, "CommandBin.general.explosionbow"))
        {
          ...
          {
            CommandBin.plugin.getConfig().set(((Player)s).getName() + ".explosionbow", Boolean.valueOf(true));
          ...
          {
            CommandBin.plugin.getConfig().set(((Player)s).getName() + ".explosionbow", Boolean.valueOf(false));
